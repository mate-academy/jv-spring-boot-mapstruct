...
public interface StudentMapper {
    ...
    @AfterMapping
    default void setSubjectIds(
            @MappingTarget StudentDto studentDto, Student student) {
    ...
    @Mapping(target = "group", source = "groupId", qualifiedByName = "getById")
    @Mapping(target = "subjects", ignore = true)
    Student toModel(CreateStudentRequestDto requestDto);

    @AfterMapping
    default void setAllIds(
